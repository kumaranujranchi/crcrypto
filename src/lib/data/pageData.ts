...
export const Companiesdata: { imgSrc: string }[] = [
  {
    imgSrc: getImagePath("/images/companies/birdseye.svg"),
  },
  {
    imgSrc: getImagePath("/images/companies/break.svg"),
  },
  {
    imgSrc: getImagePath("/images/companies/keddar.svg"),
  },
  {
    imgSrc: getImagePath("/images/companies/shield.svg"),
  },
  {
    imgSrc: getImagePath("/images/companies/tandov.svg"),
  },
  {
    imgSrc: getImagePath("/images/companies/tree.svg"),
  },
];

export const workdata: WorkType[] = [
  {
    imgSrc: getImagePath("/images/work/icon-one.svg"),
  ...
  {
    imgSrc: getImagePath("/images/work/icon-two.svg"),
    heading: "Add Funds",
    subheading:
  ...
  {
    imgSrc: getImagePath("/images/work/icon-three.svg"),
...
export const Sociallinkdata: SocialType[] = [
  {
    imgsrc: getImagePath("/images/footer/insta.svg"),
    href: "https://instagram.com/",
  },
  {
    imgsrc: getImagePath("/images/footer/dribble.svg"),
    href: "https://dribble.com/",
  },
  {
    imgsrc: getImagePath("/images/footer/twitter.svg"),
    href: "https://twitter.com/",
  },
  {
    imgsrc: getImagePath("/images/footer/youtube.svg"),
